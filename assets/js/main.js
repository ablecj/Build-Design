(function ($) {
  ...
  $(document).ready(function () {
    ...
    // new code for the gallery slider
    function gallaryScroll() {
    gsap.config({
        force3D: true,
    });

    $(".gallary-wrap").each(function () {
        ...
        // Clone items
        const $clone = $imageContainer.children().clone();

        // Remove Venobox from duplicated items
        $clone.find("a").removeClass("venobox");
        $clone.find("a").removeAttr("data-gall");
...
//             $(".mobile-side-menu, .mobile-side-menu-overlay")
//                 .removeClass("is-open");
